...
/>
  ...
  description="משכנתא לאיחוד הלוואות הינה משכנתא הנלקחת על מנת לאחד מספר הלוואות וחובות קיימים להלוואה אחת. באמצעות לקיחת משכנתא לכל מטרה יוכל הלווה לפרוע הלוואות מסוגים שונים ולקבל הלוואה אחת בריבית נמוכה. משכנתא לאיחוד הלוואות מעניקה ללווה: <br>• הפחתה בהחזר החודשי <br>• החזר תשלום במועד אחד"
/>
<Specialties
  icon={loan}
  title="משכנתא חדשה"
  description="ליווי מלא, אישי וצמוד בתהליך רכישת: <br>• נכס מקבלן <br>• דירת יד שנייה <br>• מחיר למשתכן <br>אנחנו ב-X-Home מתמחים באפיון והתאמת משכנתא מכל הסוגים עבור הלקוחות שלנו. אנו נלווה אתכם בכל הדרך בליווי אישי ובמינימום מאמץ והתעסקות מצדכם מרגע האפיון ועד לקבלת כספי המימון."
/>
    </div>  
