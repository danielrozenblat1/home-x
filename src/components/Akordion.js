...
לאורך חיי המשכנתא. אנחנו ב- Home-X יודעים לבנות ביחד איתכם את התמהיל המדויק ביותר עבורכם בהתחשב באופי העסקה שלכם, יכולת 
ההחזר וההתנהלות הפיננסית שלכם"/>
      <DropdownAccordion title="חיווי האשראי שלי שלילי, איך אני עדיין יכול לקבל משכנתא ?" content="ישנם מספר פתרונות אפשריים לקבלת משכנתא במצבים אלו. כל בנק בודק באופן שונה את הלווה והתנהלותו הכלכלית. אנחנו ב Home-X 
