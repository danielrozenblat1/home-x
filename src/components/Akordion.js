...
אנחנו ב-Home-X עובדים באופן צמוד עם כל הבנקים ונשדך עבורכם את הבנק המתאים ביותר בהתאם לאופי המשכנתא."/>
      <DropdownAccordion title= "מה זה תמהיל ומה החשיבות שלו בלקיחת משכנתא ?" content="התמהיל הוא הדבר הכי חשוב בבניית המשכנתא. התמהיל מורכב מבחירת מסלולי הריבית וסוגי לוחות הסילוקין. אין נוסחה לתמהיל האידאלי ולכל לווה יתאים תמהיל אחר.
בניית תמהיל נכון עבור הלווה יכולה לייצר חיסכון של עשרות ועד מאות אלפי שקלים לאורך חיי המשכנתא.
אנחנו ב-Home-X יודעים לבנות ביחד איתכם את התמהיל המדויק ביותר עבורכם בהתחשב באופי העסקה שלכם, יכולת ההחזר וההתנהלות הפיננסית שלכם." />
      <DropdownAccordion title="חיווי האשראי שלי לא תקין, איך אני עדיין יכול לקבל משכנתא ?" content="ישנם מספר פתרונות אפשריים לקבלת משכנתא במצבים אלו. כל בנק בודק באופן שונה את הלווה והתנהלותו הכלכלית.
אנחנו ב-Home-X מכירים את שיטות הבדיקה של כל הבנקים ונדע עוד לפני הגשת הבקשה באילו בנקים נוכל לאשר משכנתא.
"/>
